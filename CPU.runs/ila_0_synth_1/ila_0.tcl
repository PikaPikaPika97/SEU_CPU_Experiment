...
namespace eval ::optrace {
  variable script "C:/code_local/vivado/CPU/CPU.runs/ila_0_synth_1/ila_0.tcl"
...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/code_local/vivado/CPU/CPU.runs/ila_0_synth_1 -new_name ila_0 -ip [get_ips ila_0]]
...
if { [catch {
  file copy -force C:/code_local/vivado/CPU/CPU.runs/ila_0_synth_1/ila_0.dcp c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/code_local/vivado/CPU/CPU.runs/ila_0_synth_1/ila_0_stub.v c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/code_local/vivado/CPU/CPU.runs/ila_0_synth_1/ila_0_stub.vhdl c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/code_local/vivado/CPU/CPU.runs/ila_0_synth_1/ila_0_sim_netlist.v c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/code_local/vivado/CPU/CPU.runs/ila_0_synth_1/ila_0_sim_netlist.vhdl c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/code_local/vivado/CPU/CPU.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_stub.v C:/code_local/vivado/CPU/CPU.ip_user_files/ip/ila_0
  }
}

if {[file isdir C:/code_local/vivado/CPU/CPU.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force c:/code_local/vivado/CPU/CPU.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl C:/code_local/vivado/CPU/CPU.ip_user_files/ip/ila_0
  }
}
