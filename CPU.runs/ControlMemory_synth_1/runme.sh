...
HD_PWD='C:/code_local/vivado/CPU/SEU_CPU_Experiment/CPU.runs/ControlMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ControlMemory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ControlMemory.tcl
