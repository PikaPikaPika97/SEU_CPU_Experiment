...
namespace eval ::optrace {
  variable script "C:/code_local/vivado/CPU/SEU_CPU_Experiment/CPU.runs/impl_1/TOP.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/code_local/vivado/CPU/SEU_CPU_Experiment/CPU.runs/synth_1/TOP.dcp
